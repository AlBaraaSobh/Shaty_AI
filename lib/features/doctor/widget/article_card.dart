...
class ArticleCard extends StatelessWidget {
  ...
  void _handleLikeAction(BuildContext context) {
    ...
    if (_isInsideDoctorProfileScreen(context)) {
      ...
      context.read<PatientArticleCubit>().likeArticle(article.id);
    }
  }
    ...
    return Row(
      ...
      children: [
        ...
        _PostAction(
          ...
          onPressed: () {
            // حدث العدد محلياً قبل الانتقال
            if (_isInsideDoctorProfileScreen(context)) {
              context.read<ArticleCubit>().incrementCommentCount(article.id);
            } else {
              context.read<PatientArticleCubit>().incrementCommentCount(article.id);
            }
        ...
        _PostAction(
          ...
          onPressed: () {
            ...
            if (_isInsideDoctorProfileScreen(context)) {
              ...
              // مستخدم مريض
              final patientCubit = context.read<PatientArticleCubit>();
              isSavedCubit.toggleSaveArticle(article.id);
              patientCubit.toggleLocalSaveStatus(article.id);
            }
