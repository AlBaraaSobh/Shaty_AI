...
class DioConsumer extends ApiConsumer{
  ...
  @override
  Future delete(String path, {Object? data, Map<String, dynamic>? queryParameters, Options? options}) async{
    // TODO: implement delete
    final response = await dio.delete(path, data: data, options: options, queryParameters: queryParameters);
  ...
  Future get(String path, {Object? data, Map<String, dynamic>? queryParameters, Options? options})async{
    // TODO: implement
    final response = await dio.get(path,data: data ,options: options,queryParameters: queryParameters);
    return response.data ;
